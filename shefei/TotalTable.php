...
<script>
	...
	function search_totaltable(id, name, phone) 
	{
		...
		var arr = { c_id:'gettotaltable', pos:'#headingThree' };
				...
				<div class="panel-group tool-tips widget-shadow" id="accordion" role="tablist" aria-multiselectable="true">
					...
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
						  	<div class="panel-body">
								<form id="total_table_add" action="php/control.php?c_id=totaltableadd" method="post" enctype="multipart/form-data">
									<label for="file">文件名:</label>
									<span><input type="file" name="file" accept=".XLS,.xlsx" id="file" /></span>
									<br/>
									<select name="table_source" id="table_source" class="form-control2" form="total_table_add">
									...
									&nbsp;&nbsp;&nbsp;
									<label> <input type="checkbox" name="wechat">&nbsp;微信</label>
									<br/>
									<br/>
									<input type="submit" class="btn btn-primary" value="提交" />
								</form>
						...
						<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
						  	<div class="panel-body">
								...
								<table class="table table-bordered table-striped no-margin grd_tble">
									<thead>
										<tr> <th>ID</th> <th>名字</th> <th>电话</th> <th>微信号</th> <th>状态</th> <th>地址</th> <th>描述</th> <th>来源</th> </tr>
									</thead>
